        ...
        <div className="relative rounded-3xl bg-primary-900 dark:bg-primary-950 overflow-hidden p-8 md:p-16 text-center">
          ...
          <div className="relative">
            <h2 className="text-3xl md:text-4xl font-bold text-warm-50 max-w-2xl mx-auto leading-tight">
              Siap Memulai Konsultasi Monitoring Perangkat?
            </h2>
            <p className="mt-4 text-warm-300 max-w-xl mx-auto">
              Hubungi tim Matamata melalui WhatsApp untuk konsultasi gratis. Kami bantu pahami kebutuhan, kompatibilitas perangkat, dan paket yang sesuai.
            </p>
            <div className="mt-8">
              <a
                href={getWhatsAppLink('Halo Matamata, saya ingin memulai konsultasi tentang layanan monitoring perangkat.')}
                target="_blank"
