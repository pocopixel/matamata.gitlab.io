...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Ya. Penggunaan layanan monitoring perangkat harus dilakukan secara sah dan dengan otoritas yang berizin atas perangkat yang dimonitor. Pemantauan tanpa izin, stalking, penyalahgunaan data, dan pencurian kredensial dilarang. Pastikan Anda memahami dan mematuhi peraturan yang berlaku.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Tidak. Ketersediaan fitur dapat berbeda berdasarkan perangkat, sistem operasi, versi aplikasi, paket, dan ketentuan layanan. Beberapa fitur mungkin memerlukan akses root (Android) atau jailbreak (iOS) untuk berfungsi penuh. Verifikasi melalui konsultasi sebelum memilih paket.',
  },
  {
    question: 'Bagaimana informasi pengguna diproses?',
    answer:
      'Informasi yang Anda berikan saat konsultasi — seperti nama, nomor WhatsApp, email, dan detail percakapan — diproses sebagaimana dijelaskan dalam Kebijakan Privasi kami. Kami tidak membagikan informasi Anda kepada pihak ketiga tanpa persetujuan.',
  },
];
